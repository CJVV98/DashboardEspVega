...
/**
 * Clase encargada del maneji de puntos de venta
 */
export class MapsComponent implements OnInit {
    ...
    /**
     * Eliminar puntos de pago
     * @param row datos del punto de pago
     */
    delete(row: any) {
    ...
    /**
     * Aplicar filtros sobre la tabla
     * @param event 
     */
